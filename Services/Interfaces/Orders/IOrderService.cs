...
public interface IOrderService
{
    ...
    Task<IReadOnlyList<OrderDto>> CheckoutAsync(Guid userId, CheckoutDto dto, CancellationToken ct = default);
    Task<OrderDto?> UpdateDeliveryAddressAsync(Guid userId, Guid id, DeliveryAddressDto dto, CancellationToken ct = default);
